...
public class BlockManageActivity extends Activity {
	...
	private Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			switch (msg.what) {			
			case 1:				
				if(msg.obj.equals("blockinfo_shanghai.zip")){					
					...
					if (shanghaiPB.getProgress() == shanghaiPB.getMax()){
						Toast.makeText(BlockManageActivity.this, R.string.success, Toast.LENGTH_SHORT).show();
						
						Shanghaidown_btn.setClickable(false);		
						final String zipFile=rootDir+"/mobilemap/db/blockinfo_shanghai.zip/blockinfo_shanghai.zip";
...
//						new File(zipFile).getParentFile().delete();
				...
				}else if(msg.obj.equals("blockinfo_beijing.zip")){
					...
					if (beijingPB.getProgress() == beijingPB.getMax()){
						...
						final String zipFile=rootDir+"/mobilemap/db/blockinfo_beijing.zip/blockinfo_beijing.zip";
						final String targetDir=rootDir+"/mobilemap/db/";
...
//						new File(zipFile).getParentFile().delete();
				...
				}else if(msg.obj.equals("blockinfo_anhui.zip")){
					...
					if (AnHuiPB.getProgress() == AnHuiPB.getMax()){
						...
						final String zipFile=rootDir+"/mobilemap/db/blockinfo_anhui.zip/blockinfo_anhui.zip";
						final String targetDir=rootDir+"/mobilemap/db/";
...
//						new File(zipFile).getParentFile().delete();
				...
				}else if(msg.obj.equals("blockinfo_chongqing.zip")){
					...
					if (ChongQingPB.getProgress() == ChongQingPB.getMax()){
						...
						final String zipFile=rootDir+"/mobilemap/db/blockinfo_chongqing.zip/blockinfo_chongqing.zip";
						final String targetDir=rootDir+"/mobilemap/db/";
...
//						new File(zipFile).getParentFile().delete();
				...
				}else if(msg.obj.equals("blockinfo_fujian.zip")){
					...
					if (FuJianPB.getProgress() == FuJianPB.getMax()){
						...
						final String zipFile=rootDir+"/mobilemap/db/blockinfo_fujian.zip/blockinfo_fujian.zip";
						final String targetDir=rootDir+"/mobilemap/db/";
...
//						new File(zipFile).getParentFile().delete();
				...
				}else if(msg.obj.equals("blockinfo_gansu.zip")){
					...
					if (GanSuPB.getProgress() == GanSuPB.getMax()){
						...
						final String zipFile=rootDir+"/mobilemap/db/blockinfo_gansu.zip/blockinfo_gansu.zip";
						final String targetDir=rootDir+"/mobilemap/db/";
...
//						new File(zipFile).getParentFile().delete();
				...
				}else if(msg.obj.equals("blockinfo_guangdong.zip")){
					...
					if (GuangDongPB.getProgress() == GuangDongPB.getMax()){
						...
						final String zipFile=rootDir+"/mobilemap/db/blockinfo_guangdong.zip/blockinfo_guangdong.zip";
						final String targetDir=rootDir+"/mobilemap/db/";
...
//						new File(zipFile).getParentFile().delete();
				...
				}else if(msg.obj.equals("blockinfo_guangxi.zip")){
					...
					if (GuangXiPB.getProgress() == GuangXiPB.getMax()){
						...
						final String zipFile=rootDir+"/mobilemap/db/blockinfo_guangxi.zip/blockinfo_guangxi.zip";
						final String targetDir=rootDir+"/mobilemap/db/";
...
//						new File(zipFile).getParentFile().delete();
				...
				}else if(msg.obj.equals("blockinfo_guizhou.zip")){
					...
					if (GuiZhouPB.getProgress() == GuiZhouPB.getMax()){
						...
						final String zipFile=rootDir+"/mobilemap/db/blockinfo_guizhou.zip/blockinfo_guizhou.zip";
						final String targetDir=rootDir+"/mobilemap/db/";
...
//						new File(zipFile).getParentFile().delete();
				...
				}else if(msg.obj.equals("blockinfo_hainan.zip")){
					...
					if (HaiNanPB.getProgress() == HaiNanPB.getMax()){
						...
						final String zipFile=rootDir+"/mobilemap/db/blockinfo_hainan.zip/blockinfo_hainan.zip";
						final String targetDir=rootDir+"/mobilemap/db/";
...
//						new File(zipFile).getParentFile().delete();
				...
				}else if(msg.obj.equals("blockinfo_hebei.zip")){
					...
					if (HeBeiPB.getProgress() == HeBeiPB.getMax()){
						...
						final String zipFile=rootDir+"/mobilemap/db/blockinfo_hebei.zip/blockinfo_hebei.zip";
						final String targetDir=rootDir+"/mobilemap/db/";
...
//						new File(zipFile).getParentFile().delete();
				...
				}else if(msg.obj.equals("blockinfo_heilongjiang.zip")){
					...
					if (HeiLongJiangPB.getProgress() == HeiLongJiangPB.getMax()){
						...
						final String zipFile=rootDir+"/mobilemap/db/blockinfo_heilongjiang.zip/blockinfo_heilongjiang.zip";
						final String targetDir=rootDir+"/mobilemap/db/";
...
//						new File(zipFile).getParentFile().delete();
				...
				}else if(msg.obj.equals("blockinfo_henan.zip")){
					...
					if (HeNanPB.getProgress() == HeNanPB.getMax()){
						...
						final String zipFile=rootDir+"/mobilemap/db/blockinfo_henan.zip/blockinfo_henan.zip";
						final String targetDir=rootDir+"/mobilemap/db/";
...
//						new File(zipFile).getParentFile().delete();
				...
				}else if(msg.obj.equals("blockinfo_hubei.zip")){
					...
					if (HuBeiPB.getProgress() == HuBeiPB.getMax()){
						...
						final String zipFile=rootDir+"/mobilemap/db/blockinfo_hubei.zip/blockinfo_hubei.zip";
						final String targetDir=rootDir+"/mobilemap/db/";
...
//						new File(zipFile).getParentFile().delete();
				...
				}else if(msg.obj.equals("blockinfo_hunan.zip")){
					...
					if (HuNanPB.getProgress() == HuNanPB.getMax()){
						...
						final String zipFile=rootDir+"/mobilemap/db/blockinfo_hunan.zip/blockinfo_hunan.zip";
						final String targetDir=rootDir+"/mobilemap/db/";
...
//						new File(zipFile).getParentFile().delete();
				...
				}else if(msg.obj.equals("blockinfo_jiangsu.zip")){
					...
					if (JiangSuPB.getProgress() == JiangSuPB.getMax()){
						...
						final String zipFile=rootDir+"/mobilemap/db/blockinfo_jiangsu.zip/blockinfo_jiangsu.zip";
						final String targetDir=rootDir+"/mobilemap/db/";
...
//						new File(zipFile).getParentFile().delete();
				...
				}else if(msg.obj.equals("blockinfo_jiangxi.zip")){
					...
					if (JiangXiPB.getProgress() == JiangXiPB.getMax()){
						...
						final String zipFile=rootDir+"/mobilemap/db/blockinfo_jiangxi.zip/blockinfo_jiangxi.zip";
						final String targetDir=rootDir+"/mobilemap/db/";
...
//						new File(zipFile).getParentFile().delete();
				...
				}else if(msg.obj.equals("blockinfo_jiling.zip")){
					...
					if (JiLingPB.getProgress() == JiLingPB.getMax()){
						...
						final String zipFile=rootDir+"/mobilemap/db/blockinfo_jiling.zip/blockinfo_jiling.zip";
						final String targetDir=rootDir+"/mobilemap/db/";
...
//						new File(zipFile).getParentFile().delete();
				...
				}else if(msg.obj.equals("blockinfo_liaoning.zip")){
					...
					if (LiaoNingPB.getProgress() == LiaoNingPB.getMax()){
						...
						final String zipFile=rootDir+"/mobilemap/db/blockinfo_liaoning.zip/blockinfo_liaoning.zip";
						final String targetDir=rootDir+"/mobilemap/db/";
...
//						new File(zipFile).getParentFile().delete();
				...
				}else if(msg.obj.equals("blockinfo_neimenggu.zip")){
					...
					if (NeiMengGuPB.getProgress() == NeiMengGuPB.getMax()){
						...
						final String zipFile=rootDir+"/mobilemap/db/blockinfo_neimenggu.zip/blockinfo_neimenggu.zip";
						final String targetDir=rootDir+"/mobilemap/db/";
...
//						new File(zipFile).getParentFile().delete();
				...
				}else if(msg.obj.equals("blockinfo_ningxia.zip")){
					...
					if (NingXiaPB.getProgress() == NingXiaPB.getMax()){
						...
						final String zipFile=rootDir+"/mobilemap/db/blockinfo_ningxia.zip/blockinfo_ningxia.zip";
						final String targetDir=rootDir+"/mobilemap/db/";
...
//						new File(zipFile).getParentFile().delete();
				...
				}else if(msg.obj.equals("blockinfo_qinghai.zip")){
					...
					if (QingHaiPB.getProgress() == QingHaiPB.getMax()){
						...
						final String zipFile=rootDir+"/mobilemap/db/blockinfo_qinghai.zip/blockinfo_qinghai.zip";
						final String targetDir=rootDir+"/mobilemap/db/";
...
//						new File(zipFile).getParentFile().delete();
				...
				}else if(msg.obj.equals("blockinfo_shaanxi.zip")){
					...
					if (ShaanXiPB.getProgress() == ShaanXiPB.getMax()){
						...
						final String zipFile=rootDir+"/mobilemap/db/blockinfo_shaanxi.zip/blockinfo_shaanxi.zip";
						final String targetDir=rootDir+"/mobilemap/db/";
...
//						new File(zipFile).getParentFile().delete();
				...
				}else if(msg.obj.equals("blockinfo_shandong.zip")){
					...
					if (ShanDongPB.getProgress() == ShanDongPB.getMax()){
						...
						final String zipFile=rootDir+"/mobilemap/db/blockinfo_shandong.zip/blockinfo_shandong.zip";
						final String targetDir=rootDir+"/mobilemap/db/";
...
//						new File(zipFile).getParentFile().delete();
				...
				}else if(msg.obj.equals("blockinfo_shanxi.zip")){
					...
					if (ShanXiPB.getProgress() == ShanXiPB.getMax()){
						...
						final String zipFile=rootDir+"/mobilemap/db/blockinfo_shanxi.zip/blockinfo_shanxi.zip";
						final String targetDir=rootDir+"/mobilemap/db/";
...
//						new File(zipFile).getParentFile().delete();
				...
				}else if(msg.obj.equals("blockinfo_sichuan.zip")){
					...
					if (SiChuanPB.getProgress() == SiChuanPB.getMax()){
						...
						final String zipFile=rootDir+"/mobilemap/db/blockinfo_sichuan.zip/blockinfo_sichuan.zip";
						final String targetDir=rootDir+"/mobilemap/db/";
...
//						new File(zipFile).getParentFile().delete();
				...
				}else if(msg.obj.equals("blockinfo_tianjing.zip")){
					...
					if (TianJinPB.getProgress() == TianJinPB.getMax()){
						...
						final String zipFile=rootDir+"/mobilemap/db/blockinfo_tianjing.zip/blockinfo_tianjing.zip";
						final String targetDir=rootDir+"/mobilemap/db/";
						Thread t1 = new Thread(){           
							public void run() {
								UnZip.upZipFile(zipFile, targetDir);
...
//						new File(zipFile).getParentFile().delete();
				...
				}else if(msg.obj.equals("blockinfo_xinjiang.zip")){
					...
					if (XinJiangPB.getProgress() == XinJiangPB.getMax()){
						...
						final String zipFile=rootDir+"/mobilemap/db/blockinfo_xinjiang.zip/blockinfo_xinjiang.zip";
						final String targetDir=rootDir+"/mobilemap/db/";
						Thread t1 = new Thread(){           
							public void run() {
								UnZip.upZipFile(zipFile, targetDir);
...
//						new File(zipFile).getParentFile().delete();
				...
				}else if(msg.obj.equals("blockinfo_yunnan.zip")){
					...
					if (YunNanPB.getProgress() == YunNanPB.getMax()){
						...
						final String zipFile=rootDir+"/mobilemap/db/blockinfo_yunnan.zip/blockinfo_yunnan.zip";
						final String targetDir=rootDir+"/mobilemap/db/";
						Thread t1 = new Thread(){           
							public void run() {
								UnZip.upZipFile(zipFile, targetDir);
...
//						new File(zipFile).getParentFile().delete();
				...
				}else if(msg.obj.equals("blockinfo_zhejiang.zip")){
					...
					if (ZheJiangPB.getProgress() == ZheJiangPB.getMax()){
						...
						final String zipFile=rootDir+"/mobilemap/db/blockinfo_zhejiang.zip/blockinfo_zhejiang.zip";
						final String targetDir=rootDir+"/mobilemap/db/";
						Thread t1 = new Thread(){           
							public void run() {
								UnZip.upZipFile(zipFile, targetDir);
...
//						new File(zipFile).getParentFile().delete();
			...
			case -1:
				Toast.makeText(BlockManageActivity.this, R.string.error, Toast.LENGTH_SHORT).show();
				break;
			}
		}
	};
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.blockmanage);
		...
		mTimeSP = this.getSharedPreferences("BLOCKTIME", Context.MODE_PRIVATE);
		
		
		isWiFi=NetUtils.isWifiConnected(BlockManageActivity.this);	
		...
		Shanghaidown_btn.setOnClickListener(new OnClickListener() {			
			...
			public void onClick(View v) {
				...
				AlertDialog.Builder builder = new Builder(BlockManageActivity.this);
				builder.setTitle(R.string.block_download);
				builder.setMessage("确定下载上海市地图块？");
				...
				builder.setPositiveButton(R.string.map_download_ok, new DialogInterface.OnClickListener(){
					...
					public void onClick(DialogInterface dialog, int which){
						...
						if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED) ) {
							String path ="http://server.lbschina.com.cn/MobileMap/DB/blockinfo_shanghai.zip";
							File dir =new File(rootDir + "/mobilemap/db","blockinfo_shanghai.zip");
							download(path, dir,"blockinfo_shanghai.zip");
						} else {
							if(!Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)){
								Toast.makeText(BlockManageActivity.this, R.string.sdcarderror,Toast.LENGTH_SHORT).show();
							}
							if(!isWiFi){
								Toast.makeText(BlockManageActivity.this, "当前无网络",Toast.LENGTH_SHORT).show();
							}		
						}	
					}
				});
			...
			public void onClick(View v) {
				...
				builder.setPositiveButton(R.string.map_download_ok, new DialogInterface.OnClickListener(){
					...
					public void onClick(DialogInterface dialog, int which){
						...
						if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
							String path ="http://server.lbschina.com.cn/MobileMap/DB/blockinfo_beijing.zip";
							File dir =new File(rootDir + "/mobilemap/db","blockinfo_beijing.zip");
							download(path, dir,"blockinfo_beijing.zip");
						} else {
							if(!Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)){
								Toast.makeText(BlockManageActivity.this, R.string.sdcarderror,Toast.LENGTH_SHORT).show();
							}
			...
			public void onClick(View v) {
				...
				builder.setPositiveButton(R.string.map_download_ok, new DialogInterface.OnClickListener(){
					...
					public void onClick(DialogInterface dialog, int which){
						...
						if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
							String path ="http://server.lbschina.com.cn/MobileMap/DB/blockinfo_tianjing.zip";
							File dir =new File(rootDir + "/mobilemap/db","blockinfo_tianjing.zip");
							download(path, dir,"blockinfo_tianjing.zip");
						} else {
							if(!Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)){
								Toast.makeText(BlockManageActivity.this, R.string.sdcarderror,Toast.LENGTH_SHORT).show();
							}
			...
			public void onClick(View v) {
				...
				builder.setPositiveButton(R.string.map_download_ok, new DialogInterface.OnClickListener(){
					...
					public void onClick(DialogInterface dialog, int which){
						...
						if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED) ) {
							String path ="http://server.lbschina.com.cn/MobileMap/DB/blockinfo_chongqing.zip";
							File dir =new File(rootDir + "/mobilemap/db","blockinfo_chongqing.zip");
							download(path, dir,"blockinfo_chongqing.zip");
						} else {
							if(!Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)){
								Toast.makeText(BlockManageActivity.this, R.string.sdcarderror,Toast.LENGTH_SHORT).show();
							}
			...
			public void onClick(View v) {
				...
				builder.setPositiveButton(R.string.map_download_ok, new DialogInterface.OnClickListener(){
					...
					public void onClick(DialogInterface dialog, int which){
						...
						if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED) ) {
							String path ="http://server.lbschina.com.cn/MobileMap/DB/blockinfo_anhui.zip";
							File dir =new File(rootDir + "/mobilemap/db","blockinfo_anhui.zip");
							download(path, dir,"blockinfo_anhui.zip");
						} else {
							if(!Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)){
								Toast.makeText(BlockManageActivity.this, R.string.sdcarderror,Toast.LENGTH_SHORT).show();
							}
			...
			public void onClick(View v) {
				...
				builder.setPositiveButton(R.string.map_download_ok, new DialogInterface.OnClickListener(){
					...
					public void onClick(DialogInterface dialog, int which){
						...
						if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED) ) {
							String path ="http://server.lbschina.com.cn/MobileMap/DB/blockinfo_fujian.zip";
							File dir =new File(rootDir + "/mobilemap/db","blockinfo_fujian.zip");
							download(path, dir,"blockinfo_fujian.zip");
						} else {
							if(!Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)){
								Toast.makeText(BlockManageActivity.this, R.string.sdcarderror,Toast.LENGTH_SHORT).show();
							}
			...
			public void onClick(View v) {
				...
				builder.setPositiveButton(R.string.map_download_ok, new DialogInterface.OnClickListener(){
					...
					public void onClick(DialogInterface dialog, int which){
						...
						if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED) ) {
							String path ="http://server.lbschina.com.cn/MobileMap/DB/blockinfo_gansu.zip";
							File dir =new File(rootDir + "/mobilemap/db","blockinfo_gansu.zip");
							download(path, dir,"blockinfo_gansu.zip");
						} else {
							if(!Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)){
								Toast.makeText(BlockManageActivity.this, R.string.sdcarderror,Toast.LENGTH_SHORT).show();
							}
			...
			public void onClick(View v) {
				...
				builder.setPositiveButton(R.string.map_download_ok, new DialogInterface.OnClickListener(){
					...
					public void onClick(DialogInterface dialog, int which){
						...
						if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED) ) {
							String path ="http://server.lbschina.com.cn/MobileMap/DB/blockinfo_guangdong.zip";
							File dir =new File(rootDir + "/mobilemap/db","blockinfo_guangdong.zip");
							download(path, dir,"blockinfo_guangdong.zip");
						} else {
							if(!Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)){
								Toast.makeText(BlockManageActivity.this, R.string.sdcarderror,Toast.LENGTH_SHORT).show();
							}
			...
			public void onClick(View v) {
				...
				builder.setPositiveButton(R.string.map_download_ok, new DialogInterface.OnClickListener(){
					...
					public void onClick(DialogInterface dialog, int which){
						...
						if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED) ) {
							String path ="http://server.lbschina.com.cn/MobileMap/DB/blockinfo_guangxi.zip";
							File dir =new File(rootDir + "/mobilemap/db","blockinfo_guangxi.zip");
							download(path, dir,"blockinfo_guangxi.zip");
						} else {
							if(!Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)){
								Toast.makeText(BlockManageActivity.this, R.string.sdcarderror,Toast.LENGTH_SHORT).show();
							}
			...
			public void onClick(View v) {
				...
				builder.setPositiveButton(R.string.map_download_ok, new DialogInterface.OnClickListener(){
					...
					public void onClick(DialogInterface dialog, int which){
						...
						if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED) ) {
							String path ="http://server.lbschina.com.cn/MobileMap/DB/blockinfo_guizhou.zip";
							File dir =new File(rootDir + "/mobilemap/db","blockinfo_guizhou.zip");
							download(path, dir,"blockinfo_guizhou.zip");
						} else {
							if(!Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)){
								Toast.makeText(BlockManageActivity.this, R.string.sdcarderror,Toast.LENGTH_SHORT).show();
							}
			...
			public void onClick(View v) {
				...
				builder.setPositiveButton(R.string.map_download_ok, new DialogInterface.OnClickListener(){
					...
					public void onClick(DialogInterface dialog, int which){
						...
						if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED) ) {
							String path ="http://server.lbschina.com.cn/MobileMap/DB/blockinfo_hainan.zip";
							File dir =new File(rootDir + "/mobilemap/db","blockinfo_hainan.zip");
							download(path, dir,"blockinfo_hainan.zip");
						} else {
							if(!Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)){
								Toast.makeText(BlockManageActivity.this, R.string.sdcarderror,Toast.LENGTH_SHORT).show();
							}
			...
			public void onClick(View v) {
				...
				builder.setPositiveButton(R.string.map_download_ok, new DialogInterface.OnClickListener(){
					...
					public void onClick(DialogInterface dialog, int which){
						...
						if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED) ) {
							String path ="http://server.lbschina.com.cn/MobileMap/DB/blockinfo_hebei.zip";
							File dir =new File(rootDir + "/mobilemap/db","blockinfo_hebei.zip");
							download(path, dir,"blockinfo_hebei.zip");
						} else {
							if(!Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)){
								Toast.makeText(BlockManageActivity.this, R.string.sdcarderror,Toast.LENGTH_SHORT).show();
							}
			...
			public void onClick(View v) {
				...
				builder.setPositiveButton(R.string.map_download_ok, new DialogInterface.OnClickListener(){
					...
					public void onClick(DialogInterface dialog, int which){
						...
						if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
							String path ="http://server.lbschina.com.cn/MobileMap/DB/blockinfo_henan.zip";
							File dir =new File(rootDir + "/mobilemap/db","blockinfo_henan.zip");
							download(path, dir,"blockinfo_henan.zip");
						} else {
							if(!Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)){
								Toast.makeText(BlockManageActivity.this, R.string.sdcarderror,Toast.LENGTH_SHORT).show();
							}
		...
		HeiLongJiangdown_btn.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				AlertDialog.Builder builder = new Builder(BlockManageActivity.this);
				builder.setTitle(R.string.block_download);
				builder.setMessage("确定下载黑龙江省地图块？");
				builder.setCancelable(false);
				builder.setPositiveButton(R.string.map_download_ok, new DialogInterface.OnClickListener(){
					@Override
					public void onClick(DialogInterface dialog, int which){
						...
						if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED) ) {
							String path ="http://server.lbschina.com.cn/MobileMap/DB/blockinfo_heilongjiang.zip";
							File dir =new File(rootDir + "/mobilemap/db","blockinfo_heilongjiang.zip");
							download(path, dir,"blockinfo_heilongjiang.zip");
						} else {
							if(!Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)){
								Toast.makeText(BlockManageActivity.this, R.string.sdcarderror,Toast.LENGTH_SHORT).show();
							}
			...
			public void onClick(View v) {
				...
				builder.setPositiveButton(R.string.map_download_ok, new DialogInterface.OnClickListener(){
					...
					public void onClick(DialogInterface dialog, int which){
						...
						if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED) ) {
							String path ="http://server.lbschina.com.cn/MobileMap/DB/blockinfo_hubei.zip";
							File dir =new File(rootDir + "/mobilemap/db","blockinfo_hubei.zip");
							download(path, dir,"blockinfo_hubei.zip");
						} else {
							if(!Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)){
								Toast.makeText(BlockManageActivity.this, R.string.sdcarderror,Toast.LENGTH_SHORT).show();
							}
			...
			public void onClick(View v) {
				...
				builder.setPositiveButton(R.string.map_download_ok, new DialogInterface.OnClickListener(){
					...
					public void onClick(DialogInterface dialog, int which){
						...
						if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED) ) {
							String path ="http://server.lbschina.com.cn/MobileMap/DB/blockinfo_hunan.zip";
							File dir =new File(rootDir + "/mobilemap/db","blockinfo_hunan.zip");
							download(path, dir,"blockinfo_hunan.zip");
						} else {
							if(!Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)){
								Toast.makeText(BlockManageActivity.this, R.string.sdcarderror,Toast.LENGTH_SHORT).show();
							}
			...
			public void onClick(View v) {
				...
				builder.setPositiveButton(R.string.map_download_ok, new DialogInterface.OnClickListener(){
					...
					public void onClick(DialogInterface dialog, int which){
						...
						editor.commit();
						if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED) ) {
							String path ="http://server.lbschina.com.cn/MobileMap/DB/blockinfo_jiling.zip";
							File dir =new File(rootDir + "/mobilemap/db","blockinfo_jiling.zip");
							download(path, dir,"blockinfo_jiling.zip");
						} else {
							if(!Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)){
								Toast.makeText(BlockManageActivity.this, R.string.sdcarderror,Toast.LENGTH_SHORT).show();
							}
			...
			public void onClick(View v) {
				...
				builder.setPositiveButton(R.string.map_download_ok, new DialogInterface.OnClickListener(){
					...
					public void onClick(DialogInterface dialog, int which){
						...
						if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED) ) {
							String path ="http://server.lbschina.com.cn/MobileMap/DB/blockinfo_jiangsu.zip";
							File dir =new File(rootDir + "/mobilemap/db","blockinfo_jiangsu.zip");
							download(path, dir,"blockinfo_jiangsu.zip");
						} else {
							if(!Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)){
								Toast.makeText(BlockManageActivity.this, R.string.sdcarderror,Toast.LENGTH_SHORT).show();
							}
			...
			public void onClick(View v) {
				...
				builder.setPositiveButton(R.string.map_download_ok, new DialogInterface.OnClickListener(){
					...
					public void onClick(DialogInterface dialog, int which){	
						...
						if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
							String path ="http://server.lbschina.com.cn/MobileMap/DB/blockinfo_jiangxi.zip";
							File dir =new File(rootDir + "/mobilemap/db","blockinfo_jiangxi.zip");
							download(path, dir,"blockinfo_jiangxi.zip");
						} else {
							if(!Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)){
								Toast.makeText(BlockManageActivity.this, R.string.sdcarderror,Toast.LENGTH_SHORT).show();
							}
			...
			public void onClick(View v) {
				...
				builder.setPositiveButton(R.string.map_download_ok, new DialogInterface.OnClickListener(){
					...
					public void onClick(DialogInterface dialog, int which){
						...
						if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED) ) {
							String path ="http://server.lbschina.com.cn/MobileMap/DB/blockinfo_liaoning.zip";
							File dir =new File(rootDir + "/mobilemap/db","blockinfo_liaoning.zip");
							download(path, dir,"blockinfo_liaoning.zip");
						} else {
							if(!Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)){
								Toast.makeText(BlockManageActivity.this, R.string.sdcarderror,Toast.LENGTH_SHORT).show();
							}
			...
			public void onClick(View v) {
				...
				builder.setPositiveButton(R.string.map_download_ok, new DialogInterface.OnClickListener(){
					...
					public void onClick(DialogInterface dialog, int which){
						...
						if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED) ) {
							String path ="http://server.lbschina.com.cn/MobileMap/DB/blockinfo_neimenggu.zip";
							File dir =new File(rootDir + "/mobilemap/db","blockinfo_neimenggu.zip");
							download(path, dir,"blockinfo_neimenggu.zip");
						} else {
							if(!Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)){
								Toast.makeText(BlockManageActivity.this, R.string.sdcarderror,Toast.LENGTH_SHORT).show();
							}
			...
			public void onClick(View v) {
				...
				builder.setPositiveButton(R.string.map_download_ok, new DialogInterface.OnClickListener(){
					...
					public void onClick(DialogInterface dialog, int which){
						...
						if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED) ) {
							String path ="http://server.lbschina.com.cn/MobileMap/DB/blockinfo_ningxia.zip";
							File dir =new File(rootDir + "/mobilemap/db","blockinfo_ningxia.zip");
							download(path, dir,"blockinfo_ningxia.zip");
						} else {
							if(!Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)){
								Toast.makeText(BlockManageActivity.this, R.string.sdcarderror,Toast.LENGTH_SHORT).show();
							}
			...
			public void onClick(View v) {
				...
				builder.setPositiveButton(R.string.map_download_ok, new DialogInterface.OnClickListener(){
					...
					public void onClick(DialogInterface dialog, int which){
						...
						if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED) ) {
							String path ="http://server.lbschina.com.cn/MobileMap/DB/blockinfo_qinghai.zip";
							File dir =new File(rootDir + "/mobilemap/db","blockinfo_qinghai.zip");
							download(path, dir,"blockinfo_qinghai.zip");
						} else {
							if(!Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)){
								Toast.makeText(BlockManageActivity.this, R.string.sdcarderror,Toast.LENGTH_SHORT).show();
							}
			...
			public void onClick(View v) {
				...
				builder.setPositiveButton(R.string.map_download_ok, new DialogInterface.OnClickListener(){
					...
					public void onClick(DialogInterface dialog, int which){
						...
						if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED) ) {
							String path ="http://server.lbschina.com.cn/MobileMap/DB/blockinfo_shandong.zip";
							File dir =new File(rootDir + "/mobilemap/db","blockinfo_shandong.zip");
							download(path, dir,"blockinfo_shandong.zip");
						} else {
							if(!Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)){
								Toast.makeText(BlockManageActivity.this, R.string.sdcarderror,Toast.LENGTH_SHORT).show();
							}
			...
			public void onClick(View v) {
				...
				builder.setPositiveButton(R.string.map_download_ok, new DialogInterface.OnClickListener(){
					...
					public void onClick(DialogInterface dialog, int which){
						...
						if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED) ) {
							String path ="http://server.lbschina.com.cn/MobileMap/DB/blockinfo_shanxi.zip";
							File dir =new File(rootDir + "/mobilemap/db","blockinfo_shanxi.zip");
							download(path, dir,"blockinfo_shanxi.zip");
						} else {
							if(!Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)){
								Toast.makeText(BlockManageActivity.this, R.string.sdcarderror,Toast.LENGTH_SHORT).show();
							}
			...
			public void onClick(View v) {
				...
				builder.setPositiveButton(R.string.map_download_ok, new DialogInterface.OnClickListener(){
					...
					public void onClick(DialogInterface dialog, int which){
						...
						editor.commit();
						if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED) ) {
							String path ="http://server.lbschina.com.cn/MobileMap/DB/blockinfo_shaanxi.zip";
							File dir =new File(rootDir + "/mobilemap/db","blockinfo_shaanxi.zip");
							download(path, dir,"blockinfo_shaanxi.zip");
						} else {
							if(!Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)){
								Toast.makeText(BlockManageActivity.this, R.string.sdcarderror,Toast.LENGTH_SHORT).show();
							}
			...
			public void onClick(View v) {
				...
				builder.setPositiveButton(R.string.map_download_ok, new DialogInterface.OnClickListener(){
					...
					public void onClick(DialogInterface dialog, int which){
						...
						editor.commit();
						if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED) ) {
							String path ="http://server.lbschina.com.cn/MobileMap/DB/blockinfo_sichuan.zip";
							File dir =new File(rootDir + "/mobilemap/db","blockinfo_sichuan.zip");
							download(path, dir,"blockinfo_sichuan.zip");
						} else {
							if(!Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)){
								Toast.makeText(BlockManageActivity.this, R.string.sdcarderror,Toast.LENGTH_SHORT).show();
							}
			...
			public void onClick(View v) {
				...
				builder.setPositiveButton(R.string.map_download_ok, new DialogInterface.OnClickListener(){
					...
					public void onClick(DialogInterface dialog, int which){
						...
						if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED) ) {
							String path ="http://server.lbschina.com.cn/MobileMap/DB/blockinfo_xinjiang.zip";
							File dir =new File(rootDir + "/mobilemap/db","blockinfo_xinjiang.zip");
							download(path, dir,"blockinfo_xinjiang.zip");
						} else {
							if(!Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)){
								Toast.makeText(BlockManageActivity.this, R.string.sdcarderror,Toast.LENGTH_SHORT).show();
							}
			...
			public void onClick(View v) {
				...
				builder.setPositiveButton(R.string.map_download_ok, new DialogInterface.OnClickListener(){
					...
					public void onClick(DialogInterface dialog, int which){
						...
						editor.commit();
						if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED) ) {
							String path ="http://server.lbschina.com.cn/MobileMap/DB/blockinfo_yunnan.zip";
							File dir =new File(rootDir + "/mobilemap/db","blockinfo_yunnan.zip");
							download(path, dir,"blockinfo_yunnan.zip");
						} else {
							if(!Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)){
								Toast.makeText(BlockManageActivity.this, R.string.sdcarderror,Toast.LENGTH_SHORT).show();
							}
			...
			public void onClick(View v) {
				...
				builder.setPositiveButton(R.string.map_download_ok, new DialogInterface.OnClickListener(){
					...
					public void onClick(DialogInterface dialog, int which){
						...
						editor.commit();
						if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED) ) {
							String path ="http://server.lbschina.com.cn/MobileMap/DB/blockinfo_zhejiang.zip";
							File dir =new File(rootDir + "/mobilemap/db","blockinfo_zhejiang.zip");
							download(path, dir,"blockinfo_zhejiang.zip");
						} else {
							if(!Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)){
								Toast.makeText(BlockManageActivity.this, R.string.sdcarderror,Toast.LENGTH_SHORT).show();
							}
	...
	private void download(final String path, final File dir,String msgFileName) {
		...
		new Thread(new Runnable() {
			...
			public void run() {
				try {
					Downloader loader = new Downloader(BlockManageActivity.this,path, dir, 1);
					
					int length = loader.getFileSize();// 获取文件的长度
					
					if(msgName.equals("blockinfo_shanghai.zip")){
						shanghaiPB.setMax(length);
					}else if(msgName.equals("blockinfo_beijing.zip")){
						beijingPB.setMax(length);
					}else if(msgName.equals("blockinfo_anhui.zip")){
						AnHuiPB.setMax(length);
					}else if(msgName.equals("blockinfo_chongqing.zip")){
						ChongQingPB.setMax(length);
					}else if(msgName.equals("blockinfo_fujian.zip")){
						FuJianPB.setMax(length);
					}else if(msgName.equals("blockinfo_gansu.zip")){
						GanSuPB.setMax(length);
					}else if(msgName.equals("blockinfo_guangdong.zip")){
						GuangDongPB.setMax(length);
					}else if(msgName.equals("blockinfo_guangxi.zip")){
						GuangXiPB.setMax(length);
					}else if(msgName.equals("blockinfo_guizhou.zip")){
						GuiZhouPB.setMax(length);
					}else if(msgName.equals("blockinfo_hainan.zip")){
						HaiNanPB.setMax(length);
					}else if(msgName.equals("blockinfo_hebei.zip")){
						HeBeiPB.setMax(length);
					}else if(msgName.equals("blockinfo_heilongjiang.zip")){
						HeiLongJiangPB.setMax(length);
					}else if(msgName.equals("blockinfo_henan.zip")){
						HeNanPB.setMax(length);
					}else if(msgName.equals("blockinfo_hubei.zip")){
						HuBeiPB.setMax(length);
					}else if(msgName.equals("blockinfo_hunan.zip")){
						HuNanPB.setMax(length);
					}else if(msgName.equals("blockinfo_jiangsu.zip")){
						JiangSuPB.setMax(length);
					}else if(msgName.equals("blockinfo_jiangxi.zip")){
						JiangXiPB.setMax(length);
					}else if(msgName.equals("blockinfo_jiling.zip")){
						JiLingPB.setMax(length);
					}else if(msgName.equals("blockinfo_liaoning.zip")){
						LiaoNingPB.setMax(length);
					}else if(msgName.equals("blockinfo_neimenggu.zip")){
						NeiMengGuPB.setMax(length);
					}else if(msgName.equals("blockinfo_ningxia.zip")){
						NingXiaPB.setMax(length);
					}else if(msgName.equals("blockinfo_qinghai.zip")){
						QingHaiPB.setMax(length);
					}else if(msgName.equals("blockinfo_shaanxi.zip")){
						ShaanXiPB.setMax(length);
					}else if(msgName.equals("blockinfo_shandong.zip")){
						ShanDongPB.setMax(length);
					}else if(msgName.equals("blockinfo_shanxi.zip")){
						ShanXiPB.setMax(length);
					}else if(msgName.equals("blockinfo_sichuan.zip")){
						SiChuanPB.setMax(length);
					}else if(msgName.equals("blockinfo_tianjing.zip")){
						TianJinPB.setMax(length);
					}else if(msgName.equals("blockinfo_xinjiang.zip")){
						XinJiangPB.setMax(length);
					}else if(msgName.equals("blockinfo_yunnan.zip")){
						YunNanPB.setMax(length);
					}else if(msgName.equals("blockinfo_zhejiang.zip")){
						ZheJiangPB.setMax(length);
					}else if(msgName.equals("blockinfo_shanghai.zip")){
						shanghaiPB.setMax(length);
					}
	...
	private void ReturnMainPage() {
		...
		myIntent = new Intent(BlockManageActivity.this, MainActivity.class);
	...
	protected void onResume() {
		...
		File ShangHaifile=new File(rootDir+"/mobilemap/db/blockinfo_shanghai.zip");    
		...
		File BeiJingfile=new File(rootDir+"/mobilemap/db/blockinfo_beijing.zip");    
		...
		File TianJingfile=new File(rootDir+"/mobilemap/db/blockinfo_tianjing.zip");    
		...
		File ChongQingfile=new File(rootDir+"/mobilemap/db/blockinfo_chongqing.zip");    
		...
		File AnHuifile=new File(rootDir+"/mobilemap/db/blockinfo_anhui.zip");    
		if(AnHuifile.exists()) {
		...
		File FuJianfile=new File(rootDir+"/mobilemap/db/blockinfo_fujian.zip");    
		...
		File GanSufile=new File(rootDir+"/mobilemap/db/blockinfo_gansu.zip");    
		if(GanSufile.exists()) {
		...
		File GuangDongfile=new File(rootDir+"/mobilemap/db/blockinfo_guangdong.zip");    
		...
		File GuangXifile=new File(rootDir+"/mobilemap/db/blockinfo_guangxi.zip");    
		...
		File GuiZhoufile=new File(rootDir+"/mobilemap/db/blockinfo_guizhou.zip");    
		...
		File HaiNanfile=new File(rootDir+"/mobilemap/db/blockinfo_hainan.zip");    
		...
		File HeBeifile=new File(rootDir+"/mobilemap/db/blockinfo_hebei.zip");    
		if(HeBeifile.exists()) {
		...
		File HeNanfile=new File(rootDir+"/mobilemap/db/blockinfo_henan.zip");    
		if(HeNanfile.exists()) {
		...
		File HeiLongJiangfile=new File(rootDir+"/mobilemap/db/blockinfo_heilongjiang.zip");    
		...
		File HuBeifile=new File(rootDir+"/mobilemap/db/blockinfo_hubei.zip");    
		if(HuBeifile.exists()) {
		...
		File HuNanfile=new File(rootDir+"/mobilemap/db/blockinfo_hunan.zip");    
		if(HuNanfile.exists()) {
		...
		File JiLingfile=new File(rootDir+"/mobilemap/db/blockinfo_jiling.zip");    
		...
		File JiangSufile=new File(rootDir+"/mobilemap/db/blockinfo_jiangsu.zip");    
		...
		File JiangXifile=new File(rootDir+"/mobilemap/db/blockinfo_jiangxi.zip");    
		...
		File LiaoNingfile=new File(rootDir+"/mobilemap/db/blockinfo_liaoning.zip");    
		...
		File NeiMengGufile=new File(rootDir+"/mobilemap/db/blockinfo_neimenggu.zip");    
		...
		File NingXiafile=new File(rootDir+"/mobilemap/db/blockinfo_ningxia.zip");    
		...
		File QingHaifile=new File(rootDir+"/mobilemap/db/blockinfo_qinghai.zip");    
		...
		File ShanDongfile=new File(rootDir+"/mobilemap/db/blockinfo_shandong.zip");    
		...
		File ShanXifile=new File(rootDir+"/mobilemap/db/blockinfo_shanxi.zip");    
		...
		File ShaanXifile=new File(rootDir+"/mobilemap/db/blockinfo_shaanxi.zip");    
		...
		File SiChuanfile=new File(rootDir+"/mobilemap/db/blockinfo_sichuan.zip");    
		...
		File XinJiangfile=new File(rootDir+"/mobilemap/db/blockinfo_xinjiang.zip");    
		...
		File YunNanfile=new File(rootDir+"/mobilemap/db/blockinfo_yunnan.zip");    
		...
		File ZheJiangfile=new File(rootDir+"/mobilemap/db/blockinfo_zhejiang.zip");    
